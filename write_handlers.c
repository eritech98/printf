...
/************* WRITE NUMBER ****/
/**
 * write_number -This ffunction  Prints a string
...
/**
 * write_num - Write a number usin bufffer
 ...
 * @is_negative: Number indICATEDf the num is negative
 ...
 * @ind: Index a starts in the buffer
 * @length: Length of number
 * @width: Wwidth specifier
 * @flags: Flags specifier
 * @padd: Char representing the padding
 * @extra_c: Charg extra char
